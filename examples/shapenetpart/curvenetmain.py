...
def train_one_epoch(model, train_loader, criterion, segcriterion, optimizer, scheduler, epoch, cfg):
    ...
    for idx, data in pbar:
       ...
       # print(data['x'].shape)
        #logits = model(data)
        #print(data['cls'])
        logits = model(data['x'],label_one_hot)
       # print(logits.shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg', type=str, default="D:/pythonproject/Pointnext/cfgs/shapenetpart/curvenetdefault.yaml", help='config file')
