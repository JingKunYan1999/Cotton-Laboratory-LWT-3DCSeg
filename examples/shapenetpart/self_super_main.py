...
from datautils.SelfSuperviseLoss import My_super_loss, ChamferLoss, MultiLossLayer
import math
import time
import random
import copy
...
def calcorrcoef(data,data1):  #互相关矩阵计算
...
def convertmultiview(data):  #随机多视角变换
    pathlists = ["D:/pythonproject/Pointnext/examples/shapenetpart/multiviewparam/viewpoint1.json","D:/pythonproject/Pointnext/examples/shapenetpart/multiviewparam/viewpoint2.json",
                 "D:/pythonproject/Pointnext/examples/shapenetpart/multiviewparam/viewpoint3.json","D:/pythonproject/Pointnext/examples/shapenetpart/multiviewparam/viewpoint4.json",
                 "D:/pythonproject/Pointnext/examples/shapenetpart/multiviewparam/viewpoint5.json","D:/pythonproject/Pointnext/examples/shapenetpart/multiviewparam/viewpoint6.json",
                 "D:/pythonproject/Pointnext/examples/shapenetpart/multiviewparam/viewpoint7.json","D:/pythonproject/Pointnext/examples/shapenetpart/multiviewparam/viewpoint8.json"]
...
def transformerposition(data):    #随机旋转
...
def main(gpu, cfg):
   ...
   # if cfg.model.get('decoder_args', None):
    ...
    globalcriterion = My_super_loss(cfg.batch_size).cuda()  # batch_size
    localcriterion = ChamferLoss().cuda()
    #finalcriterion = Finalloss().cuda()
    finalcriterion = MultiLossLayer(3).cuda()
...
def train_one_epoch(model, train_loader, globalcriterion, localcriterion, finalcriterion, optimizer, scheduler, epoch, cfg):
    ...
    for idx, (data,data2,xyzdata) in pbar:
        # print(data['pos'][0].shape)
        # print(data2['pos'][0].shape)
        # print(xyzdata['pos'][0].shape)
       # oridataxyz = data['pos']
       ...
       # print(data2.keys())
        ...
        logits,  sa1first, sa3first, p0first = model(data)
        logits2, sa1sec, sa3sec, p0sec = model(data2)
