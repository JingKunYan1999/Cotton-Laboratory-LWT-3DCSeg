...
def get_ins_mious_1(pred, target, cls, cls2parts,multihead=False,):
    """Get the Shape IoU
    shape IoU: the mean part iou for each shape
    Args:
        pred (_type_): _description_
...
def main(gpu, cfg):
   ...
   #  selfprepath = r"D:\pythonproject\Pointnext\examples\shapenetpart\log\shapenetpart\810selfbest\checkpoint\ckpt_best.pth"
...
def train_one_epoch(model, train_loader, criterion, segcriterion, optimizer, scheduler, epoch, cfg):
    ...
    for idx, data in pbar:
       ...
       # print(to_categorical(data['cls'],1).shape)
        logits = model(data_all,label_one_hot)    # data['pos']
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg', type=str, default="../../cfgs/shapenetpart/pctdefault.yaml", help='config file')  #
